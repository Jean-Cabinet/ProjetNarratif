...
namespace ProjetNarratif.Quête
{
    internal class AubergeE : Quest
    {
     ...
     celui - ci se mit à muter légére, une sorte d'écaille d'un pureté rayonnate recouvrit l'avant bras d'Edvars
      Edavrs de Ragn - Hmm... intéressant, il semblerait que cette épée soit plus que ce que je ne  le pensais. 

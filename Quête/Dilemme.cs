...
A peine, il eut le temps de levé la tête qu'il voit le cadavre du leshen  se décomposer, pour laisser place à un corps d'une femme.
Edvars se leva en sursaut et ne comprena pas ce qu'il se passa. Il entenda au loin les gémissments de la femme qui suppliait à l'aide. Edvars alla le voir:
Edvar de Ragn - Qui etes vous ? ou est passé le cadavre du leshen à sacrifier ?
???????- S'il vous plaît ne me sacrifier pas, épargner moi ayez pitié. la femme répéta sans arret cette phrase sans jamais répondre au question d'edvars.
        ...
        internal override void ReceiveChoice(string choice, Edvars e)
        {
            switch (choice)
            {
                case "S":
                    ...
                    Console.WriteLine("Edvars planta son épée dans le corps de la femme, celui-ci cria à l'agonie tout en suppliant edvars d'arrêter");
                    Thread.Sleep(2000);
                ...
                case "E":
                    ...
                    Console.ReadKey();
                    Console.ReadKey();
                    Console.WriteLine("La femme se releva et remercia edvars");

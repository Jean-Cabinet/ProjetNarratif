...
{
    internal class RencontreE : Quest
    {
        internal override string CreateDescription() =>
@"Le chasseur s'enfuit quand il vit qu'il perdait, dans l'attente de pouvoir accomplir sa mission de tuer notre renégat. Après cette interlude
  mouvementé, Edvars repris la route en direction de la capitale de Berg. Sur la route, il croisa un marchand ambulant probablement un herboriste.
